...
const notification = new Notification("¡Conoce el Destino de tu Proxima ruta!", {
    body: "Aqui encontraras cada ruta para llegar a cada Peblo Magico.",
    icon: "/logoutec.png",
    timeout: 1500000,
    vibrate: [100, 100, 100],
    onClick: function(){
        window.location = "/artesanos.html";
        console.log(this);
    }
});
